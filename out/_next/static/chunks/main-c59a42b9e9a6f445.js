  ...
  [179],
  {
    ...
    5274: function (e, t, r) {
      ...
      function K(e) {
        var t;
        let { children: r } = e,
          a = y.default.useMemo(() => (0, B.adaptForAppRouterInstance)(n), []);
          ...
          !(function (e, t) {
            ...
            if (ee) {
              ...
              (ee = _.default.hydrateRoot(e, r, {
                ...
                (et = !1);
          })(l, (e) => y.default.createElement(eo, { callbacks: [e, p] }, m)),
          h
        );
      }
      async function el(e) {
    ...
    4642: function (e, t, r) {
      "use strict";
      Object.defineProperty(t, "__esModule", { value: !0 }), r(1885);
      let n = r(5274);
      (window.next = {
        version: n.version,
        get router() {
    ...
    5932: function (e, t, r) {
      ...
      async function N(e) {
        ...
        let { pathname: r } = (0, _.parsePath)(e.asPath),
          n = (0, j.hasBasePath)(r) ? (0, P.removeBasePath)(r) : r,
      ...
      class V {
        ...
        async change(e, t, r, n, a) {
          ...
          this._inFlightRoute &&
            this.clc &&
            (X ||
              V.events.emit("routeChangeError", I(), this._inFlightRoute, J),
            this.clc(),
            (this.clc = null)),
            (r = (0, w.addBasePath)(
              (0, b.addLocale)(
                (0, j.hasBasePath)(r) ? (0, P.removeBasePath)(r) : r,
                n.locale,
                this.defaultLocale,
              ),
            ));
          ...
          try {
            ...
            if (
              ...
              let e = (0, j.hasBasePath)(ee.pathname)
            ...
            if ((o.__N_SSG || o.__N_SSP) && o.props) {
              ...
              if (
                ((q.isPreview = !!o.props.__N_PREVIEW), o.props.notFound === U)
              ) {
                let e;
                try {
            ...
            if (!v) {
              ...
              if (o.error)
                throw (
                  (F || V.events.emit("routeChangeError", o.error, Q, J),
                  o.error)
                );
              F || V.events.emit("routeChangeComplete", r, J),
